...
def dotnet_binary(name, srcs, deps = [], defines = None, out = None, resources = None, data = None):
    _dotnet_binary(name = "%s_exe" % name, deps = deps, srcs = srcs, out = out, defines = defines, resources = resources, data = data)
    exe = ":%s_exe" % name
